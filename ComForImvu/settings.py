"""
Django settings for ComForImvu project.
...
# SECRET_KEY = '2eh2v&hjd*)c57kojvln(qpy&v7g^35c=oa03d+kf_avp9s5n-'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, '/app/forum/templates/forum/forum/main.html')
            ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ComForImvu.wsgi.application'
